...
-- NULLIF(컬럼명, 값1) : 특정값과 같으면 NULL로 변경, 아니라면 원래 값을 유지
...
UPDATE TBL_STUDENT
SET STUDENT_GRADE  = 'B'
WHERE (STUDENT_MATH + STUDENT_ENG + STUDENT_KOR) / 3 >= 80 AND 
	(STUDENT_MATH + STUDENT_ENG + STUDENT_KOR) / 3 < 90;
